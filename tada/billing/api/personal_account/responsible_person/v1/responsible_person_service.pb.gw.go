...
func request_ResponsiblePersonService_GetCountsList_0(ctx context.Context, marshaler runtime.Marshaler, client ResponsiblePersonServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetListRequest
	var metadata runtime.ServerMetadata
...
func local_request_ResponsiblePersonService_GetCountsList_0(ctx context.Context, marshaler runtime.Marshaler, server ResponsiblePersonServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetListRequest
	var metadata runtime.ServerMetadata
...
func RegisterResponsiblePersonServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ResponsiblePersonServiceServer) error {
	...
	mux.Handle("POST", pattern_ResponsiblePersonService_GetCountsList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/tada.billing.api.personal_account.responsible_person.v1.ResponsiblePersonService/GetCountsList", runtime.WithHTTPPathPattern("/tada.billing.api.personal_account.responsible_person.v1.ResponsiblePersonService/GetCountsList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ResponsiblePersonService_GetCountsList_0(ctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ResponsiblePersonService_GetCountsList_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterResponsiblePersonServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ResponsiblePersonServiceClient) error {
	...
	mux.Handle("POST", pattern_ResponsiblePersonService_GetCountsList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/tada.billing.api.personal_account.responsible_person.v1.ResponsiblePersonService/GetCountsList", runtime.WithHTTPPathPattern("/tada.billing.api.personal_account.responsible_person.v1.ResponsiblePersonService/GetCountsList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResponsiblePersonService_GetCountsList_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ResponsiblePersonService_GetCountsList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"tada.billing.api.personal_account.responsible_person.v1.ResponsiblePersonService", "GetCountsList"}, ""))
...
var (
	...
	forward_ResponsiblePersonService_GetCountsList_0 = runtime.ForwardResponseMessage
