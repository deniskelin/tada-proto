...
func RegisterPersonalAccountServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PersonalAccountServiceServer) error {
	...
	mux.Handle("POST", pattern_PersonalAccountService_GetCountsList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/tada.billing.api.personal_account.entity.v1.PersonalAccountService/GetCountsList", runtime.WithHTTPPathPattern("/tada.billing.api.personal_account.entity.v1.PersonalAccountService/GetCountsList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterPersonalAccountServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PersonalAccountServiceClient) error {
	...
	mux.Handle("POST", pattern_PersonalAccountService_GetCountsList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/tada.billing.api.personal_account.entity.v1.PersonalAccountService/GetCountsList", runtime.WithHTTPPathPattern("/tada.billing.api.personal_account.entity.v1.PersonalAccountService/GetCountsList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_PersonalAccountService_GetCountsList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"tada.billing.api.personal_account.entity.v1.PersonalAccountService", "GetCountsList"}, ""))
