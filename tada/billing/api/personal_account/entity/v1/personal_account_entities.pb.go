...
type PersonalAccountIdentity struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Identity:
	//	*PersonalAccountIdentity_IdIdentity
	//	*PersonalAccountIdentity_OwnerUuid
	//	*PersonalAccountIdentity_TeamUuid
	Identity isPersonalAccountIdentity_Identity `protobuf_oneof:"identity"`
}

func (x *PersonalAccountIdentity) Reset() {
	*x = PersonalAccountIdentity{}
...
func (x *PersonalAccountIdentity) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PersonalAccountIdentity) ProtoMessage() {}

func (x *PersonalAccountIdentity) ProtoReflect() protoreflect.Message {
	mi := &file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_msgTypes[0]
...
// Deprecated: Use PersonalAccountIdentity.ProtoReflect.Descriptor instead.
func (*PersonalAccountIdentity) Descriptor() ([]byte, []int) {
	return file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_rawDescGZIP(), []int{0}
}

func (m *PersonalAccountIdentity) GetIdentity() isPersonalAccountIdentity_Identity {
	if m != nil {
		return m.Identity
	}
	return nil
...
func (x *PersonalAccountIdentity) GetIdIdentity() *ArrayId {
	if x, ok := x.GetIdentity().(*PersonalAccountIdentity_IdIdentity); ok {
		return x.IdIdentity
	}
	return nil
}

func (x *PersonalAccountIdentity) GetOwnerUuid() string {
	if x, ok := x.GetIdentity().(*PersonalAccountIdentity_OwnerUuid); ok {
		return x.OwnerUuid
	}
	return ""
}

func (x *PersonalAccountIdentity) GetTeamUuid() string {
	if x, ok := x.GetIdentity().(*PersonalAccountIdentity_TeamUuid); ok {
		return x.TeamUuid
	}
	return ""
}

type isPersonalAccountIdentity_Identity interface {
	isPersonalAccountIdentity_Identity()
}

type PersonalAccountIdentity_IdIdentity struct {
	IdIdentity *ArrayId `protobuf:"bytes,1,opt,name=id_identity,json=idIdentity,proto3,oneof"`
}

type PersonalAccountIdentity_OwnerUuid struct {
	OwnerUuid string `protobuf:"bytes,2,opt,name=owner_uuid,json=ownerUuid,proto3,oneof"`
}

type PersonalAccountIdentity_TeamUuid struct {
	TeamUuid string `protobuf:"bytes,3,opt,name=team_uuid,json=teamUuid,proto3,oneof"`
}

func (*PersonalAccountIdentity_IdIdentity) isPersonalAccountIdentity_Identity() {}

func (*PersonalAccountIdentity_OwnerUuid) isPersonalAccountIdentity_Identity() {}

func (*PersonalAccountIdentity_TeamUuid) isPersonalAccountIdentity_Identity() {}
...
func (x *UserElement) Reset() {
	*x = UserElement{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserElement) Descriptor() ([]byte, []int) {
	return file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_rawDescGZIP(), []int{3}
}
...
var file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbe, 0x01, 0x0a, 0x17, 0x50, 0x65, 0x72, 0x73,
	0x6f, 0x6e, 0x61, 0x6c, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x12, 0x57, 0x0a, 0x0b, 0x69, 0x64, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x74, 0x61, 0x64, 0x61, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x55, 0x75, 0x69, 0x64, 0x42,
...
var file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_goTypes = []interface{}{
	(*PersonalAccountIdentity)(nil), // 0: tada.billing.api.personal_account.entity.v1.PersonalAccountIdentity
	(*ArrayId)(nil),                 // 1: tada.billing.api.personal_account.entity.v1.ArrayId
	(*Element)(nil),                 // 2: tada.billing.api.personal_account.entity.v1.Element
	(*UserElement)(nil),             // 3: tada.billing.api.personal_account.entity.v1.UserElement
...
var file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_depIdxs = []int32{
	1, // 0: tada.billing.api.personal_account.entity.v1.PersonalAccountIdentity.id_identity:type_name -> tada.billing.api.personal_account.entity.v1.ArrayId
...
func file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PersonalAccountIdentity); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*PersonalAccountIdentity_IdIdentity)(nil),
		(*PersonalAccountIdentity_OwnerUuid)(nil),
		(*PersonalAccountIdentity_TeamUuid)(nil),
	}
	file_tada_billing_api_personal_account_entity_v1_personal_account_entities_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
