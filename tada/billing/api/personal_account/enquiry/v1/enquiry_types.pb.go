...
const (
	EnquiryPaymentStatus_ENQUIRY_PAYMENT_STATUS_UNSPECIFIED EnquiryPaymentStatus = 0
	// Ожидание подтверждения оплаты
	EnquiryPaymentStatus_ENQUIRY_PAYMENT_STATUS_WAITING_CONFIRMATION EnquiryPaymentStatus = 1
	// Ожидание зачисления оплаты
	EnquiryPaymentStatus_ENQUIRY_PAYMENT_STATUS_WAITING_CREDITING EnquiryPaymentStatus = 2
	// Оплачено
	EnquiryPaymentStatus_ENQUIRY_PAYMENT_STATUS_PAID EnquiryPaymentStatus = 3
)

// Enum value maps for EnquiryPaymentStatus.
var (
	EnquiryPaymentStatus_name = map[int32]string{
		0: "ENQUIRY_PAYMENT_STATUS_UNSPECIFIED",
		1: "ENQUIRY_PAYMENT_STATUS_WAITING_CONFIRMATION",
		2: "ENQUIRY_PAYMENT_STATUS_WAITING_CREDITING",
		3: "ENQUIRY_PAYMENT_STATUS_PAID",
	}
	EnquiryPaymentStatus_value = map[string]int32{
		"ENQUIRY_PAYMENT_STATUS_UNSPECIFIED":          0,
		"ENQUIRY_PAYMENT_STATUS_WAITING_CONFIRMATION": 1,
		"ENQUIRY_PAYMENT_STATUS_WAITING_CREDITING":    2,
		"ENQUIRY_PAYMENT_STATUS_PAID":                 3,
	}
)

func (x EnquiryPaymentStatus) Enum() *EnquiryPaymentStatus {
	p := new(EnquiryPaymentStatus)
	*p = x
	return p
}

func (x EnquiryPaymentStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EnquiryPaymentStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_tada_billing_api_personal_account_enquiry_v1_enquiry_types_proto_enumTypes[0].Descriptor()
}

func (EnquiryPaymentStatus) Type() protoreflect.EnumType {
	return &file_tada_billing_api_personal_account_enquiry_v1_enquiry_types_proto_enumTypes[0]
}

func (x EnquiryPaymentStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EnquiryPaymentStatus.Descriptor instead.
func (EnquiryPaymentStatus) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	// Ожидание
	EnquiryStatus_ENQUIRY_STATUS_WAITING EnquiryStatus = 1
	// Отменено
	EnquiryStatus_ENQUIRY_STATUS_CANCELLED EnquiryStatus = 2
	// Активная
	EnquiryStatus_ENQUIRY_STATUS_ACTIVE EnquiryStatus = 3
	// Просрочено
	EnquiryStatus_ENQUIRY_STATUS_EXPIRED EnquiryStatus = 4
	// Выполнено
	EnquiryStatus_ENQUIRY_STATUS_DONE EnquiryStatus = 5
)
...
var (
	EnquiryStatus_name = map[int32]string{
		...
		1: "ENQUIRY_STATUS_WAITING",
		2: "ENQUIRY_STATUS_CANCELLED",
		3: "ENQUIRY_STATUS_ACTIVE",
		4: "ENQUIRY_STATUS_EXPIRED",
		5: "ENQUIRY_STATUS_DONE",
	}
	EnquiryStatus_value = map[string]int32{
		"ENQUIRY_STATUS_UNSPECIFIED": 0,
		"ENQUIRY_STATUS_WAITING":     1,
		"ENQUIRY_STATUS_CANCELLED":   2,
		"ENQUIRY_STATUS_ACTIVE":      3,
		"ENQUIRY_STATUS_EXPIRED":     4,
		"ENQUIRY_STATUS_DONE":        5,
	}
)
...
func (PaymentType) Descriptor() protoreflect.EnumDescriptor {
	return file_tada_billing_api_personal_account_enquiry_v1_enquiry_types_proto_enumTypes[3].Descriptor()
}

func (PaymentType) Type() protoreflect.EnumType {
	return &file_tada_billing_api_personal_account_enquiry_v1_enquiry_types_proto_enumTypes[3]
}
...
func (PaymentType) EnumDescriptor() ([]byte, []int) {
	return file_tada_billing_api_personal_account_enquiry_v1_enquiry_types_proto_rawDescGZIP(), []int{3}
}
...
var file_tada_billing_api_personal_account_enquiry_v1_enquiry_types_proto_rawDesc = []byte{
	...
	0x2a, 0xbe, 0x01, 0x0a, 0x14, 0x45, 0x6e, 0x71, 0x75, 0x69, 0x72, 0x79, 0x50, 0x61, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x26, 0x0a, 0x22, 0x45, 0x4e, 0x51,
	0x55, 0x49, 0x52, 0x59, 0x5f, 0x50, 0x41, 0x59, 0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x53, 0x54, 0x41,
	0x54, 0x55, 0x53, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10,
	0x00, 0x12, 0x2f, 0x0a, 0x2b, 0x45, 0x4e, 0x51, 0x55, 0x49, 0x52, 0x59, 0x5f, 0x50, 0x41, 0x59,
	...
	,
	...
	,
	...
	0x74, 0x2e, 0x65, 0x6e, 0x71, 0x75, 0x69, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a, 0x58,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2f, 0x65, 0x6e, 0x71, 0x75, 0x69, 0x72, 0x79, 0x2f, 0x76, 0x31,
	0x3b, 0x65, 0x6e, 0x71, 0x75, 0x69, 0x72, 0x79, 0xaa, 0x02, 0x2b, 0x54, 0x61, 0x64, 0x61, 0x2e,
	0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x2e, 0x41, 0x70, 0x69, 0x2e, 0x50, 0x65, 0x72, 0x73,
	0x6f, 0x6e, 0x61, 0x6c, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x71, 0x75,
	0x69, 0x72, 0x79, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x2b, 0x54, 0x61, 0x64, 0x61, 0x5c, 0x42, 0x69,
	0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x5c, 0x41, 0x70, 0x69, 0x5c, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e,
	0x61, 0x6c, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5c, 0x45, 0x6e, 0x71, 0x75, 0x69, 0x72,
...
var file_tada_billing_api_personal_account_enquiry_v1_enquiry_types_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_tada_billing_api_personal_account_enquiry_v1_enquiry_types_proto_goTypes = []interface{}{
	(EnquiryPaymentStatus)(0), // 0: tada.billing.api.personal_account.enquiry.v1.EnquiryPaymentStatus
	(EnquiryStatus)(0),        // 1: tada.billing.api.personal_account.enquiry.v1.EnquiryStatus
