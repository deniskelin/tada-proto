...
func RegisterInvoiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InvoiceServer) error {
	...
	mux.Handle("POST", pattern_Invoice_CreateInvoice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/tada.api.payment.Invoice/CreateInvoice", runtime.WithHTTPPathPattern("/api/v1/payment.Invoice/CreateInvoice"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Invoice_CreateInvoice_0(ctx, inboundMarshaler, server, req, pathParams)
...
func RegisterInvoiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InvoiceClient) error {
	...
	mux.Handle("POST", pattern_Invoice_CreateInvoice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/tada.api.payment.Invoice/CreateInvoice", runtime.WithHTTPPathPattern("/api/v1/payment.Invoice/CreateInvoice"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Invoice_CreateInvoice_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Invoice_CreateInvoice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "payment.Invoice", "CreateInvoice"}, ""))
)
