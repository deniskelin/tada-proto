...
var file_tada_gateway_admin_billing_personal_account_enquiry_v1_enquiry_service_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x82, 0x08, 0x0a, 0x0e, 0x45, 0x6e,
	...
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x3a, 0x01, 0x2a, 0x42, 0x8e,
	0x02, 0x0a, 0x36, 0x74, 0x61, 0x64, 0x61, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e,
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x62, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x65,
	0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x65,
	0x6e, 0x71, 0x75, 0x69, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a, 0x62, 0x67, 0x69, 0x74,
	...
	0x6f, 0x6e, 0x61, 0x6c, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2f, 0x65, 0x6e, 0x71,
	0x75, 0x69, 0x72, 0x79, 0x2f, 0x76, 0x31, 0x3b, 0x65, 0x6e, 0x71, 0x75, 0x69, 0x72, 0x79, 0xaa,
	0x02, 0x35, 0x54, 0x61, 0x64, 0x61, 0x2e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x41,
	...
	0x75, 0x69, 0x72, 0x79, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x35, 0x54, 0x61, 0x64, 0x61, 0x5c, 0x47,
...
var file_tada_gateway_admin_billing_personal_account_enquiry_v1_enquiry_service_proto_goTypes = []interface{}{
	...
	(*v1.CreateResponse)(nil),       // 6: tada.billing.api.personal_account.enquiry.v1.CreateResponse
	(*v1.UpdateResponse)(nil),       // 7: tada.billing.api.personal_account.enquiry.v1.UpdateResponse
	(*v1.GetListResponse)(nil),      // 8: tada.billing.api.personal_account.enquiry.v1.GetListResponse
	(*v1.DeleteResponse)(nil),       // 9: tada.billing.api.personal_account.enquiry.v1.DeleteResponse
	(*v1.ChangeStatusResponse)(nil), // 10: tada.billing.api.personal_account.enquiry.v1.ChangeStatusResponse
}
var file_tada_gateway_admin_billing_personal_account_enquiry_v1_enquiry_service_proto_depIdxs = []int32{
	...
	6,  // 6: tada.gateway.admin.billing.personal_account.enquiry.v1.EnquiryService.Create:output_type -> tada.billing.api.personal_account.enquiry.v1.CreateResponse
	7,  // 7: tada.gateway.admin.billing.personal_account.enquiry.v1.EnquiryService.Update:output_type -> tada.billing.api.personal_account.enquiry.v1.UpdateResponse
	8,  // 8: tada.gateway.admin.billing.personal_account.enquiry.v1.EnquiryService.Get:output_type -> tada.billing.api.personal_account.enquiry.v1.GetListResponse
	8,  // 9: tada.gateway.admin.billing.personal_account.enquiry.v1.EnquiryService.GetList:output_type -> tada.billing.api.personal_account.enquiry.v1.GetListResponse
	9,  // 10: tada.gateway.admin.billing.personal_account.enquiry.v1.EnquiryService.Delete:output_type -> tada.billing.api.personal_account.enquiry.v1.DeleteResponse
	10, // 11: tada.gateway.admin.billing.personal_account.enquiry.v1.EnquiryService.ChangeStatus:output_type -> tada.billing.api.personal_account.enquiry.v1.ChangeStatusResponse
