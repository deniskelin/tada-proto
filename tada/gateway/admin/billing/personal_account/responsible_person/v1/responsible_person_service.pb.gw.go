...
import (
	...
	"github.com/deniskelin/tada-proto/tada/billing/api/personal_account/responsible_person/v1"
...
func RegisterResponsiblePersonServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ResponsiblePersonServiceServer) error {
	...
	mux.Handle("POST", pattern_ResponsiblePersonService_GetCountsList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/tada.gateway.admin.billing.personal_account.responsible_person.v1.ResponsiblePersonService/GetCountsList", runtime.WithHTTPPathPattern("/personal_account.responsible_person/GetCountsList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterResponsiblePersonServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ResponsiblePersonServiceClient) error {
	...
	mux.Handle("POST", pattern_ResponsiblePersonService_GetCountsList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/tada.gateway.admin.billing.personal_account.responsible_person.v1.ResponsiblePersonService/GetCountsList", runtime.WithHTTPPathPattern("/personal_account.responsible_person/GetCountsList"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_ResponsiblePersonService_GetCountsList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"personal_account.responsible_person", "GetCountsList"}, ""))
